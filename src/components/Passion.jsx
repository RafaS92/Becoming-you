...
function Passion() {
    return (
        ...
        <div className="passion-container" id="passion">
            ...
            <div className="passion-img-container">
            ...
            <div className="passion-text">
                 <strong>Company</strong>
                    ...
                    <p>
                    We’ve since cultivated our fitness center management expertise through working with corporate clients of all sizes and industries.
